...
function member_list(dai){
    ...
    switch(dai){
	    ...
	    break;
    	case 6:
	    pass = ['arisu','gaku','kirio','kuin','sheru','sikibu','jan','sunsuke','tokimori','don','nagi','nimo','nerieru','hati','patora','biri-','biinasu','ponii','masamune','moepon','riida'];    
            name = ['有栖','楽','きりお','くいん','しぇる','しきぶ','ジャン','すんすけ','ときもり','ドン','なぎ','ニモ','ねりえる','8','ぱとら','びりー','びーなす','ぽにぃ','マサムネ','もえぽん','りーだぁ'];
	    shozoku = 'th6';
	    num = 22;
	    break;
	case 7:
	    pass = ['asagi','atamin','orumu','komugi','koremitu','sion','sei','soreiyu','tuyu','pikorin','pipi','foron','beru','maya','pomerin','ravin','rate','riri-','ruxuna','rein','rebekka','romi','romio'];    
            name = ['あさぎ','あたみん','おるむ','こむぎ','文秀','詩音','犀','ソレイユ','つゆ','ぴこりん','ぴぴ','ふぉろん','べる','ぽめりん','マヤ','らゔぃん','ラテ','リリー','るぅな','れいん','レベッカ','ロミ','ろみお'];
	    shozoku = 'th7';
	    num = 21;
	default:
            break;
