...
function member_list(dai){
    ...
    switch(dai){
        ...
        case 3:
            ...
            break;
        case 4:
            pass = ['itari','in','eme','ousama','ohana','oranju','kyameron','komati','shounagon','jack','suichan','sebasu','soa','cha-ri-','teika','toluri','towako','hisui','puteo','bejiyuki','pomumin','mani-','mamirin','marin','mimi','memehan','yo-guru','rimo-ne'];
            name = ['ぃたりい','院','えめ','おうさま','オハナ','おらんジュ','キャメロン','こまち','少納言','ジャック','すいちゃん','セバス','そあ','チャーリー','ていか。','トゥリ','とわこ','ひすい','ぷて男','べじゆき','ぽむみん','まにー','まみりん','まりん','みみ','めめはん','よーぐる','りもーね',];
            shozoku = 'th4';
	    num = 30;
	    break;
    	case 5:
